  ...
  return (
    <div className="min-h-screen bg-white dark:bg-ensemble-950">
      ...
      <main className="mx-auto max-w-4xl px-4 py-12">
        ...
        <p className="mb-8 text-sm text-ensemble-400">Letzte Aktualisierung: 19. März 2026</p>
        ...
        <div className="space-y-8 text-ensemble-600 dark:text-ensemble-400">
          ...
          <section>
            ...
            <p className="mt-3">
              Für Fragen zum Datenschutz wenden Sie sich bitte an die oben genannte Adresse.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Bei der Erstellung eines Kontos erheben wir: Name, E-Mail-Adresse, Passwort (verschlüsselt gespeichert),
            ...
            <p>
              ...
              Gerätetyp, Betriebssystem sowie Datum und Uhrzeit des Zugriffs. Diese Daten werden für den
              Betrieb und die Sicherheit der Plattform benötigt.
            </p>
          ...
          <section>
            ...
            <ul className="mt-2 list-inside list-disc space-y-1">
              <li><strong>Vertragsdurchführung:</strong> Verarbeitung zur Bereitstellung der Plattform und Kongressdienste.</li>
              <li><strong>Einwilligung:</strong> BLE-Standorterfassung, optionale Profilangaben, Push-Benachrichtigungen.</li>
              <li><strong>Berechtigtes Interesse:</strong> Sicherheit der Plattform, Missbrauchsprävention, Analyse zur Verbesserung.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              technischen Dienstleister für Hosting, CDN und Datenbankdienste. Cloudflare verarbeitet
          ...
          <section>
            ...
            <p>
              Wir verwenden ausschließlich technisch notwendige Cookies und Authentifizierungs-Cookies.
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  ...
                  <tr className="border-t border-ensemble-200 dark:border-ensemble-700">
                    ...
                    <td className="px-4 py-2">Design-Präferenz</td>
          ...
          <section>
            ...
            <p>
              Gemäß dem Bundesgesetz über den Datenschutz (nDSG) und der EU-Datenschutz-Grundverordnung (DSGVO)
            ...
            <ul className="mt-2 list-inside list-disc space-y-1">
              ...
              <li><strong>Datenportabilität:</strong> Sie können die Herausgabe Ihrer Daten in maschinenlesbarem Format verlangen.</li>
